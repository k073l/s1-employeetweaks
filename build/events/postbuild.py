...
Windows usage:
    python postbuild.py EmployeeTweaks.dll "C:/Games/S1/Mods" "C:/Games/S1/Schedule I.exe"

macOS/Linux with Wine:
    python postbuild.py EmployeeTweaks.dll ~/Games/S1/Mods ~/Games/S1/Schedule\ I.exe \
        --wine-binary wine64 --wine-prefix ~/.wine

Proton (Steam on Linux):
    python postbuild.py EmployeeTweaks.dll \
